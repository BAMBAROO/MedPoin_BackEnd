...
CREATE TABLE `anamnesis` (
    ...
    `no_anamnesis` VARCHAR(255) NOT NULL,
...
CREATE TABLE `pasien` (
    ...
    `tgl_daftar` TIMESTAMP(0) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `pemeriksaan` ADD CONSTRAINT `pemeriksaan_ibfk_3` FOREIGN KEY (`doctor_id`) REFERENCES `dokter`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
